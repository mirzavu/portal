#!/bin/bash
# Upload script for Multi Human Presence device

PROJECT_DIR="/home/mirza/Documents/PlatformIO/Projects/Multi human presence"

cd "$PROJECT_DIR"

echo "=========================================="
echo "Multi Human Presence Upload"
echo "=========================================="
echo ""
